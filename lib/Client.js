...
export default class Client {
    ...
    constructor(clientId, clientPassword, userId, baseURL, version, returnURL) {
     ...
     * */
    static getInstance(clientId = '', clientPassword = '', userId = '', baseURL = 'https://api.sandbox.mangopay.com', version = 'v2.01', returnURL = '') {

        if (!this.mangoPayClient)
            this.mangoPayClient = new this(clientId, clientPassword, userId, baseURL, version, returnURL);
    ...
    async _finishRegistration(paylineData) {
        ...
        try {
            ...
            if (paylineData.RegistrationData.indexOf('<!DOCTYPE html>') >= 0) {
                return {
                    "xmlhttp": null,
                    "ResultCode": "999999",
                    "ResultMessage": "CardRegistration need validation",
                    "html": paylineData.RegistrationData,
                }
            }
